...
1. In Visual Studio, create a new project. Make it a console application (using .NET 8 as the target framework, check 'Do not use top-level statements') and call it `Roommates`. The following screen will ask you where you want to put this project. Select your `workspace` directory.
